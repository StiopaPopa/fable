...
export declare const setC2: (out: Vec | null, x: number, y: number) => Vec;
export declare const setC3: (out: Vec | null, x: number, y: number, z: number) => Vec;
export declare const setC4: (out: Vec | null, x: number, y: number, z: number, w: number) => Vec;
